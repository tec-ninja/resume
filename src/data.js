const data = {
  "main": {
    ...
    "social": [
      ...
      {
        "name": "github",
        "url": "http://github.com/tec-ninja",
        "className": "fa fa-github"
      }
    ]
  },
  "resume": {
    "skillmessage": "Stacks I am most experienced in",
    "education": [
      {
        "school": "Northeastern University, China",
        "degree": "B.Sc. Computer Science",
        "graduated": "August 2013",
        "description": "Majored in computer science and started to learn web and mobile development"
      }
    ],
    "work": [
      {
  ...
  "portfolio": {
    "projects": [
      ...
      {
        "title": "My Sound Safe",
        "subtitle": "MySoundSafe offers a secure way of sharing your songs and collaborate with others using blockchain technology. I mainly worked on frontend for this project",
        "descriptions": [
          "Created reusable components with React and React Bootstrap",
          "Set up state management system utilizing Redux and integrated with backend APIs",
          "Implemented some backend APIs using Express/Node.js",
          "Refactored frontend code base and improved performance and UI/UX"
        ],
        "category": "blockchain based sound saving system",
        "images": [
          "mysoundsafe.jpg"
        ],
        "url": "http://www.mysoundsafe.com"
      }
    ]
  },
  "testimonials": {
    "testimonials": [
      {
        "text": "He is a hard working and reliable person. It has been always pleasure to work with him.",
